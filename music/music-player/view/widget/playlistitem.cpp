...
{
    QString message = QString("Are you sure you want to delete this playlist?");
    ...
    warnDlg.addButton("Cancel", false, Dtk::Widget::DDialog::ButtonNormal);
    warnDlg.addButton("Delete", true, Dtk::Widget::DDialog::ButtonWarning);
