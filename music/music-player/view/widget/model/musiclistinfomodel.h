...
class MusiclistInfomodel : public QStandardItemModel
{
    Q_OBJECT
public:
    explicit MusiclistInfomodel(QObject *parent = nullptr);
...
private:
    QScopedPointer<MusiclistInfomodelPrivate> d_ptr;
    Q_DECLARE_PRIVATE_D(qGetPtrHelper(d_ptr), MusiclistInfomodel)
};
