...
#define AC_slider_60                  QObject::tr("slider_60")
#define AC_slider_170                 QObject::tr("slider_170")
#define AC_slider_310                 QObject::tr("slider_310")
#define AC_slider_600                 QObject::tr("slider_600")
#define AC_slider_1K                  QObject::tr("slider_1K")
#define AC_slider_3K                  QObject::tr("slider_3K")
#define AC_slider_6K                  QObject::tr("slider_6K")
#define AC_slider_12K                 QObject::tr("slider_12K")
#define AC_slider_14K                 QObject::tr("slider_14K")
#define AC_slider_16K                 QObject::tr("slider_16K")
