...
DSvgButton{
    ...
    property var oneLoop_normal_image: '../../../skin/svg/simple.loop.single.svg'
    property var sequentialLoop_normal_image: '../../../skin/svg/simple.loop.list.svg'
    property var random_normal_image: '../../../skin/svg/simple.loop.random.svg'
