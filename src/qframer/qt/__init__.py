"""
This code comes from https://github.com/pyQode/pyqode.qt

**qframer.qt** is a shim over the various qt bindings. It is used to write
...
using one specific bindings and you need to use library that use qframer.qt) by
...
For pyqt5, you don't have to set anything as it will be used automatically::
    ...
    >>> from qframer.qt import QtGui, QtWidgets, QtCore
...
.. warning:: This requires to set the SIP api to version 2 (for strings and
    ...
    api is set before importing any PyQt4 module (qframer.qt can take care of
