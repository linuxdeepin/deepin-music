...
lcov --remove ./coverageResult/deepin-music-test_Coverage.info '*/deepin-music-test_autogen/*' '*/deepin-music-test_autogen/*' '*/usr/include/*' '*/tests/*' '*/googletest/*' -o ./coverageResult/deepin-music-test_Coverage.info
echo \ ===================\ do\ filter\ end\ ====================\ 
